    ...
    <nav class="navbar navbar-expand-lg align-items-center">
        ...
        <div class="div">
            <ul class="d-flex align-items-center list-unstyled float-end mb-0">
                <li class="mx-3">
                    <a href="javascript:void(0);" class="icon-h position-relative"><i
                            class="bi bi-search text-white fs-5"></i></a>
                </li>
                <li class="mx-3">
                    <a href="javascript:void(0);" class="icon-h position-relative" data-bs-toggle="modal"
        ...
        <div class="collapse navbar-collapse" id="click">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="mx-3">
                    <a href="javascript:void(0);" class="nav-link fw-semibold text-white fs-6">Products</a>
                </li>
                <li class="mx-3">
                    <a href="javascript:void(0);" class="nav-link fw-semibold text-white fs-6">Services</a>
                </li>
                <li class="mx-3">
                    <a href="javascript:void(0);" class="nav-link fw-semibold text-white fs-6">Gallery</a>
                </li>
                <li class="mx-3">
                    <a href="javascript:void(0);" class="nav-link fw-semibold text-white fs-6">Assesories</a>
                </li>
                <li class="mx-3">
                    <a href="javascript:void(0);" class="nav-link fw-semibold text-white fs-6">About</a>
                </li>
                <li class="mx-3 position-relative">
                    <a href="cart.html" class="nav-link fw-semibold text-white fs-6">Cart</a>
